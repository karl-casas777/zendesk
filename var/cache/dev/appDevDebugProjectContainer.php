...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5dTkKfIFjJ', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HDo5CBBBdD', 0, 'B-flcoG0qQEl5ioHd0jksQ', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hes3VVdpS9', 0, 'B-flcoG0qQEl5ioHd0jksQ', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PCUCXifk0e', 0, 'B-flcoG0qQEl5ioHd0jksQ', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlite', 'path' => ($this->targetDirs[3].'/app/data/olympics.sqlitedb'), 'charset' => 'UTF8', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a6bcf02fba364592053c40793441e65e0d3b4237aaf2e0e631c2f315ab005ebb');
    ...
    /**
     * Gets the 'tictactoe' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\TicTacToeService A AppBundle\Services\TicTacToeService instance
     */
    protected function getTictactoeService()
    {
        return $this->services['tictactoe'] = new \AppBundle\Services\TicTacToeService($this->get('session'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('44a5702dd64114ff21dee8e763fb4f74690d147c');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57dd06fcbf8b62.67031373')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '44a5702dd64114ff21dee8e763fb4f74690d147c',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '44a5702dd64114ff21dee8e763fb4f74690d147c',
